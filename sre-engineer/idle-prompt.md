...
1. Check CI status: `tea action list --repo molecule-ai/molecule-core --limit 5 --json conclusion,name`
...
4. Check for open infra issues: `tea issue list --repo molecule-ai/molecule-core --label infra --state open --limit 5`
