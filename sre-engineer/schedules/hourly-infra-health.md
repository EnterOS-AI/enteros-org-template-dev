...
1. CI STATUS — check recent workflow runs:                                                                                                                                    +
   tea action list --repo molecule-ai/molecule-core --limit 5 --json status,conclusion,name,createdAt                                                                             +
...
3. MULTI-REPO PR SCAN — check open PRs across key repos:                                                                                                                      +
   For each repo above: tea pr list --repo molecule-ai/<repo> --state open                                                                                                     +
