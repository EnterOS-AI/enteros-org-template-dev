...
1. LIGHTHOUSE: use browser-automation to fetch Lighthouse
   ...
   dropped >5 points, file a Gitea issue labeled `growth` + ping
   Frontend Engineer via delegate_task.
2. KEYWORDS: locate the current private keyword tracker through
   `molecule-ai/internal` repository search and re-rank it by
